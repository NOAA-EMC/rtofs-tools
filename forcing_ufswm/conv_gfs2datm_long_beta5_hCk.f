...
C  ! Get the varid of the data variable, based on its name.
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid ,"TSOIL_0M0D1mbelowground",
     &vi_TSOIL_0M0D1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILW_0M0D1mbelowground",
     &vi_SOILW_0M0D1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILL_0M0D1mbelowground",
     &vi_SOILL_0M0D1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"TSOIL_0D1M0D4mbelowground",
     &vi_TSOIL_0D1M0D4mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILW_0D1M0D4mbelowground",
     &vi_SOILW_0D1M0D4mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILL_0D1M0D4mbelowground",
     &vi_SOILL_0D1M0D4mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"TSOIL_0D4M1mbelowground",
     &vi_TSOIL_0D4M1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILW_0D4M1mbelowground",
     &vi_SOILW_0D4M1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILL_0D4M1mbelowground",
     &vi_SOILL_0D4M1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"TSOIL_1M2mbelowground",
     &vi_TSOIL_1M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILW_1M2mbelowground",
     &vi_SOILW_1M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"SOILL_1M2mbelowground",
     &vi_SOILL_1M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
!hCk      nerr=nf_inq_varid(ncid,"SOILM_0M2mbelowground",
!hCk     &vi_SOILM_0M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"UGRD_10maboveground",
     &vi_UGRD_10maboveground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"VGRD_10maboveground",
     &vi_VGRD_10maboveground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid ,
     &"PWAT_entireatmosphere_consideredasasinglelayer_", 
     &vi_PWAT_entireatmosphere_consideredasasinglelayer_ )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_inq_varid(ncid,"TCDC_convectivecloudlayer",
     &vi_TCDC_convectivecloudlayer )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
...
c     nerr=nf_get_var_int(ncid,vi_time_in, time_in )
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_TSOIL_0M0D1mbelowground,
     &TSOIL_0M0D1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILW_0M0D1mbelowground,
     &SOILW_0M0D1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILL_0M0D1mbelowground,
     &SOILL_0M0D1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_TSOIL_0D1M0D4mbelowground,
     &TSOIL_0D1M0D4mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILW_0D1M0D4mbelowground,
     &SOILW_0D1M0D4mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILL_0D1M0D4mbelowground,
     &SOILL_0D1M0D4mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_TSOIL_0D4M1mbelowground,
     &TSOIL_0D4M1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILW_0D4M1mbelowground,
     &SOILW_0D4M1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILL_0D4M1mbelowground,
     &SOILL_0D4M1mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_TSOIL_1M2mbelowground,
     &TSOIL_1M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILW_1M2mbelowground,
     &SOILW_1M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SOILL_1M2mbelowground,
     &SOILL_1M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
!hCk      nerr=nf_get_var_real(ncid,vi_SOILM_0M2mbelowground,
!hCk     &SOILM_0M2mbelowground )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_SPFH_2maboveground,
     &SPFH_2maboveground)
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_UGRD_10maboveground,
     &UGRD_10maboveground)
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_VGRD_10maboveground,
     &VGRD_10maboveground)
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid ,
     &vi_PWAT_entireatmosphere_consideredasasinglelayer_, 
     &PWAT_entireatmosphere_consideredasasinglelayer_ )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_get_var_real(ncid,vi_TCDC_convectivecloudlayer,
     &TCDC_convectivecloudlayer)
      if (nerr .ne. nf_noerr) call handle_err(nerr)
...
C: define variables
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"vbdsf_ave" ,NF_REAL, NDIM, 
     &outdim,vi_vbdsf_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"vddsf_ave" ,NF_REAL, NDIM, 
     &outdim,vi_vddsf_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"nbdsf_ave" ,NF_REAL, NDIM, 
     &outdim,vi_nbdsf_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"nddsf_ave" ,NF_REAL, NDIM, 
     &outdim,vi_nddsf_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      ...
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"shtfl_ave" ,NF_REAL, NDIM, 
     &outdim,vi_shtfl_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"lhtfl_ave" ,NF_REAL, NDIM, 
     &outdim,vi_lhtfl_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"totprcp_ave" ,NF_REAL, NDIM, 
     &outdim,vi_totprcp_ave )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"u10m" ,NF_REAL, NDIM, outdim, vi_u10m )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"v10m" ,NF_REAL, NDIM, outdim, vi_v10m )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"hgt_hyblev1" ,NF_REAL, NDIM, 
     &outdim,vi_hgt_hyblev1 )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"psurf" ,NF_REAL, NDIM, outdim, vi_psurf)
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"tmp_hyblev1" ,NF_REAL, NDIM, 
     &outdim,vi_tmp_hyblev1 )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"spfh_hyblev1" ,NF_REAL, NDIM, 
     &outdim,vi_spfh_hyblev1 )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"ugrd_hyblev1" ,NF_REAL, NDIM, 
     &outdim,vi_ugrd_hyblev1 )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"vgrd_hyblev1" ,NF_REAL, NDIM, 
     &outdim,vi_vgrd_hyblev1 )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"q2m" ,NF_REAL, NDIM, outdim, vi_q2m )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"t2m" ,NF_REAL, NDIM, outdim, vi_t2m )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"slmsksfc" ,NF_REAL, NDIM, 
     &outdim,vi_slmsksfc )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
      nerr=nf_def_var(mcid,"pres_hyblev1" ,NF_REAL, NDIM, 
     &outdim,vi_pres_hyblev1 )
      if (nerr .ne. nf_noerr) call handle_err(nerr)
...
cc           if (abs(HGT_1HYBRIDLEVEL(i,j,k)) < 1.0e10 .and.
cc     &           LAND_surface(i,j,k) == 1) then
cc            if (abs(HGT_1HYBRIDLEVEL(i,j,k)) < 1.0e11 .and.
cc     &           LAND_surface(i,j,k) == 1) then
