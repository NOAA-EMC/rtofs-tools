...
module purge
module load hpss/hpss gnu/13.2.0 intel/2023.2.0 netcdf/4.7.0 wgrib2/3.1.2_ncep cdo/2.3.0
module list
...
set odir = /scratch4/NCEPDEV/marine/Zulema.Garraffo/FV3_RT/forcing/DATM/Reanal
set wdir = /scratch4/NCEPDEV/marine/Zulema.Garraffo/FV3_RT/forcing/DATM/Tmp_get
