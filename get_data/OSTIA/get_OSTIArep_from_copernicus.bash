...
# download all files, skip directory structure
# this command stalls, maybe too big of a request
#copernicusmarine get -i $datasetID --file-list ./files_to_download.txt -nd

# separate requests for each month
for year in $( seq 1982 2025 ) ; do
...
mv *.nc /scratch3/NCEPDEV/marine/Raphael.Dussin/obs/gridded/OSTIA_reprocessed/.
