...
jobid_forecast_step2=$(qsub $batchloc/rtofs.forecast_step2.$pid)
if [ $# -gt 0 ]
then
...
if [ $configname == operations.config ]; then
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
echo just this QC job
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
exit -8
...
if [ $configname == zv3.config ]; then
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
echo just qc and 2dvar jobs
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
exit -8
fi
...
if [ $configname == release.v2n.config ]; then
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
echo just NCODA jobs
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
exit -8
fi

if [ $configname == release.v2c.config ]; then
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
echo just NCODA jobs
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
exit -8
...
#echo 
#echo
if [ $configname == rtofs.v2.5.rr.config ]; then
echo NOTICE NOTICE NOTICE NOTICE NOTICE NOTICE
