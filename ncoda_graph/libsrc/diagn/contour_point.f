      subroutine contour_point (m, n, data, dmn, dmx, n_slc,
     *                          cntr, lntr, spval)
c
c.............................START PROLOGUE............................
c
...
c      @(#)$Id$
c
c MODULE NAME:  contour_point
c
c DESCRIPTION:  this routine contours a time series at a model point
c
c PARAMETERS:
c     Name      Type    Usage          Description
c   --------   ------   -----   -----------------------------------
c   dats       real     input   data array
...
c
      call cprect (data, m, m, n, rwork, MX_WL, iwork, MX_WL)
      call cpclam (data, rwork, iwork, iamap)
c
c     ..color the map
c
...
c
      call gsplci (1)
      call gstxci (1)
      call cpsetr ('CIS - contour interval specifier', cntr)
...
c
      call cprect (data, m, m, n, rwork, MX_WL, iwork, MX_WL)
      call cpcldm (data, rwork, iwork, iamap, crsrcl)
      call cplbdr (data, rwork, iwork)
c
...
c
      ...
      call lblbar (1, .91, 1.0, .2, .8, n_slc, .25, 1.0,
