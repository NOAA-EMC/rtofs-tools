      SUBROUTINE CGYG02(NCASES,NVARS,NIND,XBAR,S,COEFF,ICOEFF,CONST,C,
     *                  IC)
...
C
C     NAG AUXILIARY ROUTINE CGYG02
...
C     .. Executable Statements ..
   ...
   40 CONTINUE
      ...
      CONST(3) = BIGNUM
      B = B*S*S
      IF (B.LE.0.0) GO TO 80
      B = SQRT(B)
      CONST(2) = B
      IF (B.LE.1.0) GO TO 60
      CONST(3) = 0.0
