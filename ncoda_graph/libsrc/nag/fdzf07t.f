      SUBROUTINE FDZF07(UPLO,N,A,LDA,INFO)
C     MARK 15 RELEASE. NAG COPYRIGHT 1991.
C     ENTRY             SPOTF2(UPLO,N,A,LDA,INFO)
C
C  Purpose
C  =======
C
C  SPOTF2 computes the Cholesky factorization of a real symmetric
...
C
      ...
      END IF
      IF (INFO.NE.0) THEN
         CALL AAZF06('FDZF07/SPOTF2',-INFO)
         RETURN
      END IF
C
