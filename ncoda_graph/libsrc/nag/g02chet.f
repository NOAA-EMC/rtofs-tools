...
C     AND AUXILIARY ROUTINE  CGZG02
C
C
...
C     .. Parameters ..
      CHARACTER*6       SRNAME
      PARAMETER         (SRNAME='G02CHE')
C     .. Scalar Arguments ..
      INTEGER           ICOEFF, ICZ, IFAIL, IRZ, IRZINV, ISSPZ, IWKZ,
     *                  NCASES, NIND, NVARS
C     .. Array Arguments ..
      REAL              COEFF(ICOEFF,3), CZ(ICZ,NIND), RESULT(13),
...
C
      IERROR = 1
      CALL F04ABE(RZ,IRZ,CZ,ICZ,NIND,NIND,RZINV,IRZINV,COEFF,WKZ,IWKZ,
     *            IERROR)
C
...
C
      CALL CGZG02(NCASES,NVARS,NIND,SSPZ,ISSPZ,RZ,IRZ,RESULT,COEFF,
