      SUBROUTINE XUUF02(JOB,D1,E1,DNM1,DN,ENM2,ENM1,C,S)
C     MARK 13 RELEASE. NAG COPYRIGHT 1988.
C
C  XUUF02  determines  the  shift parameters,  c and s,  for  the  first
...
C     .. Scalar Arguments ..
      REAL              C, D1, DN, DNM1, E1, ENM1, ENM2, S
      INTEGER           JOB
C     .. Local Scalars ..
      REAL              A, APLUSC, B, BOT, CORR, F, RSQEPS, SHIFT,
     *                  SQTEPS, TOP
      LOGICAL           FAIL, FIRST
C     .. External Functions ..
      REAL              F06BLE, X02AJE
      EXTERNAL          F06BLE, X02AJE
