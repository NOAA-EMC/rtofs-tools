      INTEGER FUNCTION ZAYF07(NAME)
C     MARK 15 RELEASE. NAG COPYRIGHT 1991.
C     MARK 16 RE-ISSUE. NAG COPYRIGHT 1993.
C
C     ZAYF07 returns a unique positive integer code
...
C
         IF (J.LT.0 .OR. K.LT.0) THEN
            ZAYF07 = 0
         ELSE
C           ZAYF07 is in the range 1-28 for F07 routines.
            ZAYF07 = 1 + 4*J + K
         END IF
C
...
C
         IF (J.LT.0 .OR. K.LT.0) THEN
            ZAYF07 = 0
         ELSE
C           ZAYF07 is in the range 29-124 for F08 routines.
            ZAYF07 = 29 + 12*J + K
         END IF
C
      ELSE
