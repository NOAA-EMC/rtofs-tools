...
tmpdir=/lfs/h2/emc/ptmp/$LOGNAME/monitor_negdp
mkdir -p $tmpdir
...
#count of neg dp
echo "Below is the number of occurrences of the string 'neg. dp' for $pdy." > $tmpdir/negdp_count.$pdy$hh
echo "If any are over zero, then the RTOFS needs investigation " >> $tmpdir/negdp_count.$pdy$hh
