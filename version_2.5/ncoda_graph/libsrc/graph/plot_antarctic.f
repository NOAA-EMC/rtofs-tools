      subroutine plot_antarctic (dir_path, date, dtg, tau, nest, m,
     *                           n, l, mask, igrid, pln, plt, node_sh,
     *                           fno, spval)
c
c.............................START PROLOGUE............................
c
...
c
      ...
      allocate (wrk3 (m * n * l))
c
c     ..loop over variable fields and increments
c
      do j = 1, 3
      do k = 1, 2
      if (j .eq. 1) then
...
c        ..plot field
c
         call glb_polar (wrk2, dmn, dmx, m, n, pln, plt, node_sh,
     *                   pos1, pos2, pos3, pos4, nslc, iamap,
     *                   MX_AMAP, lntr, 'sh', spval)
         fno = fno + 1
