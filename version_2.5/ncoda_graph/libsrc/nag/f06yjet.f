      SUBROUTINE F06YJE(SIDE,UPLO,TRANSA,DIAG,M,N,ALPHA,A,LDA,B,LDB)
...
C
C     .. Entry Points ..
      ENTRY             STRSM(SIDE,UPLO,TRANSA,DIAG,M,N,ALPHA,A,LDA,B,
     *                  LDB)
C     .. Parameters ..
      REAL              ONE, ZERO
