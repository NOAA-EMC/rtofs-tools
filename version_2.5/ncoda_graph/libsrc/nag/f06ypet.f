      SUBROUTINE F06YPE(UPLO,TRANS,N,K,ALPHA,A,LDA,BETA,C,LDC)
...
C
C     .. Entry Points ..
      ENTRY             SSYRK(UPLO,TRANS,N,K,ALPHA,A,LDA,BETA,C,LDC)
C     .. Parameters ..
      REAL              ONE, ZERO
