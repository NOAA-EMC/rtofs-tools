      SUBROUTINE XUSF02(N,D,E,WANTCS,C,S)
C     MARK 13 RELEASE. NAG COPYRIGHT 1988.
C
C  XUSF02  annihilates the element a( n - 1, n )  of a bidiagonal matrix
C  A, on the assumption that  a( n, n ) is negligible, by applying plane
C  rotations from the right.  Thus  XUSF02  performs  the transformation
C
C     A := A*P',
C
