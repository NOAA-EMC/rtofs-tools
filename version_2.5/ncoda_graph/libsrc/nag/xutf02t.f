      SUBROUTINE XUTF02(TEST,N,D,E,FORCE,P)
C     MARK 13 RELEASE. NAG COPYRIGHT 1988.
C
C  XUTF02  tests a bidiagonal matrix to see if there is a split, or if a
...
C  precision as returned by routine  X02AJE, or if
C
C    abs( d( p ) ) .lt. flmin/eps,
C
C  where  flmin  is the  underflow  threshold  as  returned  by  routine
C  X02AKE, and similarly  e( p )  is regarded as negligible if
C
...
C     .. Array Arguments ..
      REAL              D(*), E(*)
C     .. Local Scalars ..
      REAL              ABSD, ABSDI, ABSE, ABSEI, AMAX, DMAX, EMAX, EPS,
     *                  FLMIN, NEGL, SMALL
      INTEGER           I
      LOGICAL           FIRST
