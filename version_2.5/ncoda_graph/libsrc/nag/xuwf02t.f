      SUBROUTINE XUWF02(M,N,D,E,WANTCS,C,S)
C     MARK 13 RELEASE. NAG COPYRIGHT 1988.
C
C  XUWF02 annihilates the element  a( m, m + 1 )  of a bidiagonal matrix
C  A, on the assumption that  a( m, m ) is negligible, by applying plane
C  rotations from the  left.  Thus  XUWF02  performs  the transformation
C
C     A := P*A,
C
